...
public class Pager {
	...
	public static String getPagerNormal(int total, int pagesize, int pagenum,String pageurl,String info) {
		...
		if (pagenum == 1) {
			...
			buf.append("【<a href='javascript:void(0);'  onclick='fenye(1)' >首页</a>】【<a href='javascript:void(0);'  onclick='fenye("+(pagenum - 1)+")'>上一页</a>】");
		}
		...
		for (int i = bound1; i <= bound2; i++) {
			if (i == pagenum) {
				...
				buf.append("<a href='javascript:void(0);'  onclick='fenye("+(i)+")'>" + i
						+ "</a>&nbsp;&nbsp;");
			}
		}
		if (bound2 < count) {
		...
		if (pagenum == count||count==0) {
			...
			buf.append("【<a href='javascript:void(0);' onclick='fenye("+(pagenum + 1)+")'>下一页</a>】【<a href='javascript:void(0);' onclick='fenye("+(count)+")'>尾页</a>】");
		}
		return buf.toString();
	}
}
