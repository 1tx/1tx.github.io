...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" name="oname"  id="onameid" style="width: 300px;"  value="${bean.oname}" /></td>
    </tr>

    <tr>
        <td width="10%" class="tableleft">省</td>
        <td><input type="text" name="province"  id="provinceid" style="width: 300px;" value="${bean.province}"  /></td>
    </tr>

    <tr>
        <td width="10%" class="tableleft">市</td>
        <td><input type="text" name="city"  id="cityid" style="width: 300px;"  value="${bean.city}" /></td>
    </tr>

    <tr>
        <td width="10%" class="tableleft">详细地址</td>
        <td><input type="text" name="address"  id="addressid" style="width: 300px;"  value="${bean.address}" /></td>
    </tr>

    <tr>
        <td width="10%" class="tableleft">联系电话</td>
        <td><input type="text" name="phone"  id="phoneid" style="width: 300px;"  value="${bean.phone}" /></td>
    </tr>

    <tr>
        <td width="10%" class="tableleft">物流网点负责人</td>
        <td><input type="text" name="personincharge"  id="personinchargeid" style="width: 300px;"  value="${bean.personincharge}" /></td>
    </tr>

    <tr>
        <td width="10%" class="tableleft">备注</td>
        <td><input type="text" name="remark"  id="remarkid" style="width: 300px;"  value="${bean.remark}" /></td>
    </tr>
