	     ...
	     <c:forEach items="${list}" var="bean">
	       <tr>
            ...
            <td>
                ...
                <a class="btn btn-success btn-sm" href="logisticslist.do?expressId=${bean.id }">物流信息管理</a>&nbsp;

                <a class="btn btn-danger btn-sm" href="${url2 }update2.do?id=${bean.id }" onclick="{if(confirm('确认完成邮寄吗?')){return true;}return false;}">确认完成</a>&nbsp;&nbsp;&nbsp;
