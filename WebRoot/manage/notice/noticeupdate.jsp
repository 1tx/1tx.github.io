...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <td><input type="text" name="ntitle"  id="ntitleid" style="width: 300px;"  value="${bean.ntitle}" /></td>
    </tr>
    ...
    <tr>
        ...
        <td>
        <textarea style="width: 500px;height: 250px;" name="ncontent" >${bean.ncontent}</textarea>
        </td>
    </tr>
    <tr>
